...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "Calendar_at_localhost" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["calcalendar"] = "Calendar_at_localhost";
		$connectionsIds["calcategory"] = "Calendar_at_localhost";
		$connectionsIds["calperiod"] = "Calendar_at_localhost";
		$connectionsIds["calglobals"] = "Calendar_at_localhost";
		$connectionsIds["calholidays"] = "Calendar_at_localhost";
		$connectionsIds["calusers"] = "Calendar_at_localhost";
		$connectionsIds["calweekdays"] = "Calendar_at_localhost";
		$connectionsIds["calfirstday"] = "Calendar_at_localhost";
		$connectionsIds["callocale"] = "Calendar_at_localhost";
		$connectionsIds["usuarios"] = "Calendar_at_localhost";
