...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "Calendar_at_localhost";
		$data["connName"] = "Calendar at localhost";
		...
		$this->_connectionsIdByName["Calendar at localhost"] = "Calendar_at_localhost";
		...
		$connectionsData["Calendar_at_localhost"] = $data;
