...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "Calendar_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "calcalendar", "varname" => "Calendar_at_localhost__calcalendar", "altvarname" => "calcalendar", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "calcategory", "varname" => "Calendar_at_localhost__calcategory", "altvarname" => "calcategory", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "calfirstday", "varname" => "Calendar_at_localhost__calfirstday", "altvarname" => "calfirstday", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "calglobals", "varname" => "Calendar_at_localhost__calglobals", "altvarname" => "calglobals", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "calholidays", "varname" => "Calendar_at_localhost__calholidays", "altvarname" => "calholidays", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "callocale", "varname" => "Calendar_at_localhost__callocale", "altvarname" => "callocale", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "calperiod", "varname" => "Calendar_at_localhost__calperiod", "altvarname" => "calperiod", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "calusers", "varname" => "Calendar_at_localhost__calusers", "altvarname" => "calusers", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "calweekdays", "varname" => "Calendar_at_localhost__calweekdays", "altvarname" => "calweekdays", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
			$dalTables[$conn->connId][] = array("name" => "usuarios", "varname" => "Calendar_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		}
	}
