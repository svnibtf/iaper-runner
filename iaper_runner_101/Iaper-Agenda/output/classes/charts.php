...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("calcalendar" == $this->chrt_array['tables'][0])
			return true;
		if("calcategory" == $this->chrt_array['tables'][0])
			return true;
		if("calperiod" == $this->chrt_array['tables'][0])
			return true;
		if("calglobals" == $this->chrt_array['tables'][0])
			return true;
		if("calholidays" == $this->chrt_array['tables'][0])
			return true;
		if("calusers" == $this->chrt_array['tables'][0])
			return true;
		if("calweekdays" == $this->chrt_array['tables'][0])
			return true;
		if("calfirstday" == $this->chrt_array['tables'][0])
			return true;
		if("callocale" == $this->chrt_array['tables'][0])
			return true;
