...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "calcalendar" ] = array( "url" => "calcalendar", "type" => 0 );
	$projectEntitiesReverse[ "calcalendar" ] = "calcalendar";
	$projectEntities[ "calcategory" ] = array( "url" => "calcategory", "type" => 0 );
	$projectEntitiesReverse[ "calcategory" ] = "calcategory";
	$projectEntities[ "calperiod" ] = array( "url" => "calperiod", "type" => 0 );
	$projectEntitiesReverse[ "calperiod" ] = "calperiod";
	$projectEntities[ "calglobals" ] = array( "url" => "calglobals", "type" => 0 );
	$projectEntitiesReverse[ "calglobals" ] = "calglobals";
	$projectEntities[ "calholidays" ] = array( "url" => "calholidays", "type" => 0 );
	$projectEntitiesReverse[ "calholidays" ] = "calholidays";
	$projectEntities[ "calusers" ] = array( "url" => "calusers", "type" => 0 );
	$projectEntitiesReverse[ "calusers" ] = "calusers";
	$projectEntities[ "calweekdays" ] = array( "url" => "calweekdays", "type" => 0 );
	$projectEntitiesReverse[ "calweekdays" ] = "calweekdays";
	$projectEntities[ "calfirstday" ] = array( "url" => "calfirstday", "type" => 0 );
	$projectEntitiesReverse[ "calfirstday" ] = "calfirstday";
	$projectEntities[ "callocale" ] = array( "url" => "callocale", "type" => 0 );
	$projectEntitiesReverse[ "callocale" ] = "callocale";
