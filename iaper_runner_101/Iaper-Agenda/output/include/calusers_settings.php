...
{
	$fieldLabelscalusers["Portuguese(Brazil)"] = array();
	$fieldToolTipscalusers["Portuguese(Brazil)"] = array();
	$placeHolderscalusers["Portuguese(Brazil)"] = array();
	$pageTitlescalusers["Portuguese(Brazil)"] = array();
	$fieldLabelscalusers["Portuguese(Brazil)"]["id"] = "Id";
	$fieldToolTipscalusers["Portuguese(Brazil)"]["id"] = "";
	$placeHolderscalusers["Portuguese(Brazil)"]["id"] = "";
	$fieldLabelscalusers["Portuguese(Brazil)"]["username"] = "Username";
	$fieldToolTipscalusers["Portuguese(Brazil)"]["username"] = "";
	$placeHolderscalusers["Portuguese(Brazil)"]["username"] = "";
	$fieldLabelscalusers["Portuguese(Brazil)"]["password"] = "Password";
	$fieldToolTipscalusers["Portuguese(Brazil)"]["password"] = "";
	$placeHolderscalusers["Portuguese(Brazil)"]["password"] = "";
	if (count($fieldToolTipscalusers["Portuguese(Brazil)"]))
...
$tdatacalusers[".connId"] = "Calendar_at_localhost";
