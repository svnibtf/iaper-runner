...
$tdatacalcategory[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatacalcategory[".originalPagesByType"] = $tdatacalcategory[".pagesByType"];
$tdatacalcategory[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatacalcategory[".originalPages"] = $tdatacalcategory[".pages"];
$tdatacalcategory[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
{
	$fieldLabelscalcategory["Portuguese(Brazil)"] = array();
	$fieldToolTipscalcategory["Portuguese(Brazil)"] = array();
	$placeHolderscalcategory["Portuguese(Brazil)"] = array();
	$pageTitlescalcategory["Portuguese(Brazil)"] = array();
	$fieldLabelscalcategory["Portuguese(Brazil)"]["id"] = "Id";
	$fieldToolTipscalcategory["Portuguese(Brazil)"]["id"] = "";
	$placeHolderscalcategory["Portuguese(Brazil)"]["id"] = "";
	$fieldLabelscalcategory["Portuguese(Brazil)"]["Category"] = "Category";
	$fieldToolTipscalcategory["Portuguese(Brazil)"]["Category"] = "";
	$placeHolderscalcategory["Portuguese(Brazil)"]["Category"] = "";
	$fieldLabelscalcategory["Portuguese(Brazil)"]["Color"] = "Color";
	$fieldToolTipscalcategory["Portuguese(Brazil)"]["Color"] = "";
	$placeHolderscalcategory["Portuguese(Brazil)"]["Color"] = "";
	if (count($fieldToolTipscalcategory["Portuguese(Brazil)"]))
...
$tdatacalcategory[".connId"] = "Calendar_at_localhost";
