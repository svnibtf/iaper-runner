...
class tDAL
{
	var $tblCalendar_at_localhost__calcalendar;
	var $tblCalendar_at_localhost__calcategory;
	var $tblCalendar_at_localhost__calfirstday;
	var $tblCalendar_at_localhost__calglobals;
	var $tblCalendar_at_localhost__calholidays;
	var $tblCalendar_at_localhost__callocale;
	var $tblCalendar_at_localhost__calperiod;
	var $tblCalendar_at_localhost__calusers;
	var $tblCalendar_at_localhost__calweekdays;
	var $tblCalendar_at_localhost__usuarios;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "calcalendar", "varname" => "Calendar_at_localhost__calcalendar", "altvarname" => "calcalendar", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "calcategory", "varname" => "Calendar_at_localhost__calcategory", "altvarname" => "calcategory", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "calfirstday", "varname" => "Calendar_at_localhost__calfirstday", "altvarname" => "calfirstday", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "calglobals", "varname" => "Calendar_at_localhost__calglobals", "altvarname" => "calglobals", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "calholidays", "varname" => "Calendar_at_localhost__calholidays", "altvarname" => "calholidays", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "callocale", "varname" => "Calendar_at_localhost__callocale", "altvarname" => "callocale", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "calperiod", "varname" => "Calendar_at_localhost__calperiod", "altvarname" => "calperiod", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "calusers", "varname" => "Calendar_at_localhost__calusers", "altvarname" => "calusers", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "calweekdays", "varname" => "Calendar_at_localhost__calweekdays", "altvarname" => "calweekdays", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
		$this->lstTables[] = array("name" => "usuarios", "varname" => "Calendar_at_localhost__usuarios", "altvarname" => "usuarios", "connId" => "Calendar_at_localhost", "schema" => "", "connName" => "Calendar at localhost");
	}
