...
{
	$fieldLabelscalperiod["Portuguese(Brazil)"] = array();
	$fieldToolTipscalperiod["Portuguese(Brazil)"] = array();
	$placeHolderscalperiod["Portuguese(Brazil)"] = array();
	$pageTitlescalperiod["Portuguese(Brazil)"] = array();
	$fieldLabelscalperiod["Portuguese(Brazil)"]["id"] = "Id";
	$fieldToolTipscalperiod["Portuguese(Brazil)"]["id"] = "";
	$placeHolderscalperiod["Portuguese(Brazil)"]["id"] = "";
	$fieldLabelscalperiod["Portuguese(Brazil)"]["Period"] = "Period";
	$fieldToolTipscalperiod["Portuguese(Brazil)"]["Period"] = "";
	$placeHolderscalperiod["Portuguese(Brazil)"]["Period"] = "";
	$fieldLabelscalperiod["Portuguese(Brazil)"]["ValueField"] = "Value Field";
	$fieldToolTipscalperiod["Portuguese(Brazil)"]["ValueField"] = "";
	$placeHolderscalperiod["Portuguese(Brazil)"]["ValueField"] = "";
	if (count($fieldToolTipscalperiod["Portuguese(Brazil)"]))
...
$tdatacalperiod[".connId"] = "Calendar_at_localhost";
...
$tdatacalperiod[".popupPagesLayoutNames"] = $popupPagesLayoutNames;
...
$tdatacalperiod[".rowHighlite"] = true;
...
$tableEvents["calperiod"] = new eventsBase;
