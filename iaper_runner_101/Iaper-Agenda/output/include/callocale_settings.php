...
{
	$fieldLabelscallocale["Portuguese(Brazil)"] = array();
	$fieldToolTipscallocale["Portuguese(Brazil)"] = array();
	$placeHolderscallocale["Portuguese(Brazil)"] = array();
	$pageTitlescallocale["Portuguese(Brazil)"] = array();
	$fieldLabelscallocale["Portuguese(Brazil)"]["id"] = "Id";
	$fieldToolTipscallocale["Portuguese(Brazil)"]["id"] = "";
	$placeHolderscallocale["Portuguese(Brazil)"]["id"] = "";
	$fieldLabelscallocale["Portuguese(Brazil)"]["fullcalendarlocale"] = "Fullcalendarlocale";
	$fieldToolTipscallocale["Portuguese(Brazil)"]["fullcalendarlocale"] = "";
	$placeHolderscallocale["Portuguese(Brazil)"]["fullcalendarlocale"] = "";
	$fieldLabelscallocale["Portuguese(Brazil)"]["runnerlocale"] = "Runnerlocale";
	$fieldToolTipscallocale["Portuguese(Brazil)"]["runnerlocale"] = "";
	$placeHolderscallocale["Portuguese(Brazil)"]["runnerlocale"] = "";
	if (count($fieldToolTipscallocale["Portuguese(Brazil)"]))
...
$tdatacallocale[".connId"] = "Calendar_at_localhost";
...
$tdatacallocale[".popupPagesLayoutNames"] = $popupPagesLayoutNames;
...
$tdatacallocale[".rowHighlite"] = true;
...
$tableEvents["callocale"] = new eventsBase;
