...
{
	$fieldLabelscalholidays["Portuguese(Brazil)"] = array();
	$fieldToolTipscalholidays["Portuguese(Brazil)"] = array();
	$placeHolderscalholidays["Portuguese(Brazil)"] = array();
	$pageTitlescalholidays["Portuguese(Brazil)"] = array();
	$fieldLabelscalholidays["Portuguese(Brazil)"]["id"] = "Id";
	$fieldToolTipscalholidays["Portuguese(Brazil)"]["id"] = "";
	$placeHolderscalholidays["Portuguese(Brazil)"]["id"] = "";
	$fieldLabelscalholidays["Portuguese(Brazil)"]["name"] = "Name";
	$fieldToolTipscalholidays["Portuguese(Brazil)"]["name"] = "";
	$placeHolderscalholidays["Portuguese(Brazil)"]["name"] = "";
	$fieldLabelscalholidays["Portuguese(Brazil)"]["date"] = "Date";
	$fieldToolTipscalholidays["Portuguese(Brazil)"]["date"] = "";
	$placeHolderscalholidays["Portuguese(Brazil)"]["date"] = "";
	if (count($fieldToolTipscalholidays["Portuguese(Brazil)"]))
...
$tdatacalholidays[".connId"] = "Calendar_at_localhost";
...
$tableEvents["calholidays"] = new eventsBase;
