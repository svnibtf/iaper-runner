...
$tdatacalglobals[".pagesByType"] = my_json_decode( "{\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatacalglobals[".originalPagesByType"] = $tdatacalglobals[".pagesByType"];
$tdatacalglobals[".pages"] = types2pages( my_json_decode( "{\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatacalglobals[".originalPages"] = $tdatacalglobals[".pages"];
$tdatacalglobals[".defaultPages"] = my_json_decode( "{\"edit\":\"edit\",\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
{
	$fieldLabelscalglobals["Portuguese(Brazil)"] = array();
	$fieldToolTipscalglobals["Portuguese(Brazil)"] = array();
	$placeHolderscalglobals["Portuguese(Brazil)"] = array();
	$pageTitlescalglobals["Portuguese(Brazil)"] = array();
	$fieldLabelscalglobals["Portuguese(Brazil)"]["id"] = "Id";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["id"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["id"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["TimePeriod"] = "Time Period";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["TimePeriod"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["TimePeriod"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["FirstDayOfWeek"] = "First Day Of Week";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["FirstDayOfWeek"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["FirstDayOfWeek"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["EditInPast"] = "Edit In Past";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["EditInPast"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["EditInPast"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["DefaultColor"] = "Default Color";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["DefaultColor"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["DefaultColor"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["HolidayColor"] = "Holiday Color";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["HolidayColor"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["HolidayColor"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["WeekEndColor"] = "Week End Color";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["WeekEndColor"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["WeekEndColor"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["RangedColor"] = "Ranged Color";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["RangedColor"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["RangedColor"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["SubjectLength"] = "Subject Length";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["SubjectLength"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["SubjectLength"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["DescriptionLength"] = "Description Length";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["DescriptionLength"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["DescriptionLength"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["StartTime"] = "Start Time";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["StartTime"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["StartTime"] = "";
	$fieldLabelscalglobals["Portuguese(Brazil)"]["EndTime"] = "End Time";
	$fieldToolTipscalglobals["Portuguese(Brazil)"]["EndTime"] = "";
	$placeHolderscalglobals["Portuguese(Brazil)"]["EndTime"] = "";
	if (count($fieldToolTipscalglobals["Portuguese(Brazil)"]))
...
$tdatacalglobals[".connId"] = "Calendar_at_localhost";
