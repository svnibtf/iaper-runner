...
{
	$fieldLabelscalweekdays["Portuguese(Brazil)"] = array();
	$fieldToolTipscalweekdays["Portuguese(Brazil)"] = array();
	$placeHolderscalweekdays["Portuguese(Brazil)"] = array();
	$pageTitlescalweekdays["Portuguese(Brazil)"] = array();
	$fieldLabelscalweekdays["Portuguese(Brazil)"]["id"] = "Id";
	$fieldToolTipscalweekdays["Portuguese(Brazil)"]["id"] = "";
	$placeHolderscalweekdays["Portuguese(Brazil)"]["id"] = "";
	$fieldLabelscalweekdays["Portuguese(Brazil)"]["daynum"] = "Daynum";
	$fieldToolTipscalweekdays["Portuguese(Brazil)"]["daynum"] = "";
	$placeHolderscalweekdays["Portuguese(Brazil)"]["daynum"] = "";
	$fieldLabelscalweekdays["Portuguese(Brazil)"]["dayname"] = "Dayname";
	$fieldToolTipscalweekdays["Portuguese(Brazil)"]["dayname"] = "";
	$placeHolderscalweekdays["Portuguese(Brazil)"]["dayname"] = "";
	if (count($fieldToolTipscalweekdays["Portuguese(Brazil)"]))
...
$tdatacalweekdays[".connId"] = "Calendar_at_localhost";
