...
require_once("include/adm_pacientes_documentos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "adm_pacientes_documentos" );
