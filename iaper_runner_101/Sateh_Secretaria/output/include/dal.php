...
class tDAL
{
	...
	var $tbliaperdbatrobb0254publiccloudco__adm_campos_adicionais;
	var $tbliaperdbatrobb0254publiccloudco__adm_campos_paciente;
	var $tbliaperdbatrobb0254publiccloudco__adm_eventos;
	var $tbliaperdbatrobb0254publiccloudco__adm_horarios;
	var $tbliaperdbatrobb0254publiccloudco__adm_inscricoes;
	var $tbliaperdbatrobb0254publiccloudco__adm_lista_variavel;
	var $tbliaperdbatrobb0254publiccloudco__adm_pacientes;
	var $tbliaperdbatrobb0254publiccloudco__adm_pacientes_documentos;
	var $tbliaperdbatrobb0254publiccloudco__adm_pagamento_avulso;
	var $tbliaperdbatrobb0254publiccloudco__adm_parametros_config;
	var $tbliaperdbatrobb0254publiccloudco__adm_splits;
	var $tbliaperdbatrobb0254publiccloudco__adm_tipo_documentos;
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "adm_campos_adicionais", "varname" => "iaperdbatrobb0254publiccloudco__adm_campos_adicionais", "altvarname" => "adm_campos_adicionais", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		$this->lstTables[] = array("name" => "adm_campos_paciente", "varname" => "iaperdbatrobb0254publiccloudco__adm_campos_paciente", "altvarname" => "adm_campos_paciente", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		$this->lstTables[] = array("name" => "adm_eventos", "varname" => "iaperdbatrobb0254publiccloudco__adm_eventos", "altvarname" => "adm_eventos", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		...
		$this->lstTables[] = array("name" => "adm_inscricoes", "varname" => "iaperdbatrobb0254publiccloudco__adm_inscricoes", "altvarname" => "adm_inscricoes", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		$this->lstTables[] = array("name" => "adm_lista_variavel", "varname" => "iaperdbatrobb0254publiccloudco__adm_lista_variavel", "altvarname" => "adm_lista_variavel", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		...
		$this->lstTables[] = array("name" => "adm_pacientes_documentos", "varname" => "iaperdbatrobb0254publiccloudco__adm_pacientes_documentos", "altvarname" => "adm_pacientes_documentos", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		$this->lstTables[] = array("name" => "adm_pagamento_avulso", "varname" => "iaperdbatrobb0254publiccloudco__adm_pagamento_avulso", "altvarname" => "adm_pagamento_avulso", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		...
		$this->lstTables[] = array("name" => "adm_splits", "varname" => "iaperdbatrobb0254publiccloudco__adm_splits", "altvarname" => "adm_splits", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
		$this->lstTables[] = array("name" => "adm_tipo_documentos", "varname" => "iaperdbatrobb0254publiccloudco__adm_tipo_documentos", "altvarname" => "adm_tipo_documentos", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
