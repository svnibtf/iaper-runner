...
require_once("include/adm_tipo_documentos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "adm_tipo_documentos" );
