...
require_once("include/adm_campos_adicionais_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "adm_campos_adicionais" );
