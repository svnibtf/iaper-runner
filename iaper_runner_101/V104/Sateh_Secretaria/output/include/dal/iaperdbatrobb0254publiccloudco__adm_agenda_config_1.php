<?php
$dalTableadm_agenda_config_1 = array();
$dalTableadm_agenda_config_1["agc_id"] = array("type"=>3,"varname"=>"agc_id", "name" => "agc_id");
$dalTableadm_agenda_config_1["agc_usu_pro_id"] = array("type"=>3,"varname"=>"agc_usu_pro_id", "name" => "agc_usu_pro_id");
$dalTableadm_agenda_config_1["agc_nome"] = array("type"=>200,"varname"=>"agc_nome", "name" => "agc_nome");
$dalTableadm_agenda_config_1["agc_tipo"] = array("type"=>16,"varname"=>"agc_tipo", "name" => "agc_tipo");
$dalTableadm_agenda_config_1["agc_item_pagamento_id"] = array("type"=>3,"varname"=>"agc_item_pagamento_id", "name" => "agc_item_pagamento_id");
$dalTableadm_agenda_config_1["agc_qtidade"] = array("type"=>3,"varname"=>"agc_qtidade", "name" => "agc_qtidade");
$dalTableadm_agenda_config_1["agc_duracao_media"] = array("type"=>3,"varname"=>"agc_duracao_media", "name" => "agc_duracao_media");
$dalTableadm_agenda_config_1["agc_email_automatico"] = array("type"=>3,"varname"=>"agc_email_automatico", "name" => "agc_email_automatico");
$dalTableadm_agenda_config_1["agc_tempo_min_antecedencia"] = array("type"=>3,"varname"=>"agc_tempo_min_antecedencia", "name" => "agc_tempo_min_antecedencia");
$dalTableadm_agenda_config_1["agc_email_agendamento"] = array("type"=>200,"varname"=>"agc_email_agendamento", "name" => "agc_email_agendamento");
...
$dalTableadm_agenda_config_1["agc_link_consulta"] = array("type"=>200,"varname"=>"agc_link_consulta", "name" => "agc_link_consulta");
