...
require_once("include/adm_parametros_config_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "adm_parametros_config" );
