...
require_once("include/adm_agenda_estrutura_1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "adm_agenda_estrutura_1" );
