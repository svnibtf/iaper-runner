...
require_once("include/adm_plano_profissional_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "adm_plano_profissional" );
