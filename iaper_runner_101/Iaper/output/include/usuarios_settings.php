...
$tdatausuarios[".OwnerID"] = "usu_id";
$tdatausuarios[".OriginalTable"] = "usuarios";


$tdatausuarios[".pagesByType"] = my_json_decode( "{\"edit\":[\"edit\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" );
$tdatausuarios[".originalPagesByType"] = $tdatausuarios[".pagesByType"];
$tdatausuarios[".pages"] = types2pages( my_json_decode( "{\"edit\":[\"edit\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" ) );
$tdatausuarios[".originalPages"] = $tdatausuarios[".pages"];
$tdatausuarios[".defaultPages"] = my_json_decode( "{\"edit\":\"edit\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="Portuguese(Brazil)")
{
	...
	$fieldLabelsusuarios["Portuguese(Brazil)"]["usu_id"] = "Id";
	...
	$fieldLabelsusuarios["Portuguese(Brazil)"]["email_validado"] = "E-mail Validado";
	$fieldToolTipsusuarios["Portuguese(Brazil)"]["email_validado"] = "";
	$placeHoldersusuarios["Portuguese(Brazil)"]["email_validado"] = "";
	$fieldLabelsusuarios["Portuguese(Brazil)"]["permissao"] = "Permissão";
	...
	$fieldLabelsusuarios["Portuguese(Brazil)"]["data_in"] = "Data de Entrada";
	...
	$fieldLabelsusuarios["Portuguese(Brazil)"]["avatar"] = "Meu Cadastro";
	...
	$fieldLabelsusuarios["Portuguese(Brazil)"]["info_inicial"] = "Informação Inicial";
	...
	$fieldLabelsusuarios["Portuguese(Brazil)"]["telefone_celular_secundario"] = "Telefone Celular Secundário";
...
$tdatausuarios[".mainTableOwnerID"] = "usu_id";
...
//	meuplano
	...
	$detailsParam["dShortTable"] = "meuplano";
	$detailsParam["dCaptionTable"] = GetTableCaption("meuplano");
