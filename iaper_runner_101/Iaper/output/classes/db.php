...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "iaperdbatrobb0254publiccloudco" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "meuplano", "varname" => "iaperdbatrobb0254publiccloudco__meuplano", "altvarname" => "meuplano", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
			$dalTables[$conn->connId][] = array("name" => "pacientes", "varname" => "iaperdbatrobb0254publiccloudco__pacientes", "altvarname" => "pacientes", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
			$dalTables[$conn->connId][] = array("name" => "planos", "varname" => "iaperdbatrobb0254publiccloudco__planos", "altvarname" => "planos", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
			$dalTables[$conn->connId][] = array("name" => "tratamento", "varname" => "iaperdbatrobb0254publiccloudco__tratamento", "altvarname" => "tratamento", "connId" => "iaperdbatrobb0254publiccloudco", "schema" => "", "connName" => "iaper_db at robb0254.publicclo");
