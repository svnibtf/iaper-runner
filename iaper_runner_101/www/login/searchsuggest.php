...
if( $forLookupPage && count( $parentCtrlsData ) ) 
{
	...
	foreach( $mainPSet->getParentFieldsData( $mainField ) as $cData )
	{
		...
		$parentFieldValues = splitLookupValues( $parentCtrlsData[ $cData["main"] ] );
...
$result = getListOfSuggests( $allSearchFields, $table, $numberOfSuggests, $searchOpt, $searchFor, $searchField, $detailKeys );
