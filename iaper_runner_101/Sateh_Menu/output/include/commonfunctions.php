...
function checkTableName($shortTName )
{
	...
	if ("login" == $shortTName )
		return true;
	if ("buscar_profissionais" == $shortTName )
		return true;
	...
	if ("visaogeral" == $shortTName )
		return true;
	if ("adm_agenda_estrutura_1" == $shortTName )
		return true;
	if ("adm_agenda_config_1" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("buscar_profissionais");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Procurar por Profissionais");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("adm_agenda_estrutura_1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="adm_agenda_estrutura_1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("adm_agenda_config_1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("adm_agenda_tipos_recebimento");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
function SetAuthSessionData($pUsername, &$data, $password, &$pageObject = null, $fireEvents = true )
{
	...
	$_SESSION["_adm_usuarios_OwnerID"] = $data["usu_id"];
		...
		$_SESSION["_adm_pacientes_OwnerID"] = $data["usu_id"];
		$_SESSION["_adm_agenda_estrutura_1_OwnerID"] = $data["usu_id"];
		$_SESSION["_adm_agenda_config_1_OwnerID"] = $data["usu_id"];
		$_SESSION["_adm_agenda_1_OwnerID"] = $data["usu_id"];
