...
if($buttId=='Marcar_Consulta')
{
	...
	buttonHandler_Marcar_Consulta($params);
}
if($buttId=='Voltar')
{
	//  for login page users table can be turned off
...
function buttonHandler_Marcar_Consulta($params)
{
	global $strTableName;
	$result = array();
...
function buttonHandler_Voltar($params)
{
	global $strTableName;
	$result = array();
